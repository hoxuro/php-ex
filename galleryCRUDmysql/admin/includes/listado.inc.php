        ...
        <tbody>
          ...
          if (!empty($rows)) {
            ...
            foreach ($rows as $row) {
              ...
              if ($row['enabled'] == "1") {
                $enabled = "<svg width='30px' height='30px' viewBox='0 0 12 12' xmlns='http://www.w3.org/2000/svg'>
